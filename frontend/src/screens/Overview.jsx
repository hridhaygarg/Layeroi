...
const colors = {
  ...
  bgProfit: 'var(--status-profit-bg)',
  bgLoss: 'var(--status-loss-bg)',
  bgWarning: 'var(--status-warn-bg)',
  borderDefault: 'var(--border-default)',
  borderStrong: 'var(--border-strong)',
  textPrimary: 'var(--white)',
  textSecondary: 'var(--white-50)',
  textTertiary: 'var(--white-35)',
  accentGreen: 'var(--green)',
  accentGreenLight: 'var(--green-soft)',
  accentGreenBorder: 'var(--green-border)',
  dangerRed: 'var(--negative)',
  dangerLight: 'var(--negative-soft)',
  dangerBorder: 'rgba(239,68,68,0.22)',
  warningAmber: 'var(--warning)',
  warningLight: 'var(--warning-soft)',
  shadowSm: 'var(--shadow-card)',
  shadowMd: 'var(--shadow-card-hover)',
};
